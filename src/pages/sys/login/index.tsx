...
import desktopImg from "@/assets/images/background/desktop-i.png";
...
function LoginPage() {
	...
	return (
		<div
			className="relative grid min-h-svh lg:grid-cols-2 bg-background bg-cover bg-center"
			...
			<div className="flex flex-col gap-4 p-6 md:p-10">
				<div className="flex justify-center gap-2 md:justify-start">
					<div className="flex items-center gap-2 font-medium cursor-pointer">
						{/* <Logo size={28} /> */}
						<span className="text-2xl text-yellow-500">{GLOBAL_CONFIG.appName}</span>
					</div>
				</div>
